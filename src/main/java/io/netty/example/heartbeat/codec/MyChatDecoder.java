package io.netty.example.heartbeat.codec;

import io.netty.buffer.ByteBuf;
import io.netty.channel.ChannelHandlerContext;
import io.netty.example.heartbeat.heartbeat.MyHeartbeat;
import io.netty.handler.codec.ReplayingDecoder;

import java.util.List;

import static io.netty.example.heartbeat.codec.ChatProtocolState.MESSAGE_DATA;
import static io.netty.example.heartbeat.codec.ChatProtocolState.MESSAGE_PACKAGE;
import static io.netty.example.heartbeat.codec.ChatProtocolState.MESSAGE_TYPE;
